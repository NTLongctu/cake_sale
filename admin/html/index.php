...
?>
                                ...
                                <a class="dropdown-item" href="#">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <span
                                                class="fw-semibold d-block"><?php echo session::get('Username') ?></span>
                            ...
                            <div class="d-flex align-items-end row">
                                <div class="col-sm-7">
                                    <div class="card-body">
                                        ...
                                        <a href="product_list.php" class="btn btn-sm btn-outline-primary">Xem chi
                                            tiết</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3>Người Dùng</h3>
                                        <p class="card-title text-nowrap mb-1">Số lượng:
                                            <?php echo $quantity_customers ?> </p>
                                        <a href="user_list.php" class="mt-2 btn btn-sm btn-outline-primary">Xem chi
                                            tiết</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3>Phản hồi</h3>
                                        <p class="card-title text-nowrap mb-1">Số lượng:
                                            <?php echo $quantity_contacts ?> </p>
                                        <a href="contact_list.php" class="mt-2 btn btn-sm btn-outline-primary">Xem chi
                                            tiết</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row row-bordered g-0">
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-sm-between flex-wrap">
                                        ...
                                        <select class="form-select" id="thang" onchange="changeMonth()">
                                            <option value="" <?php echo ($selectedMonth == "") ? 'selected' : ''; ?>>Tất
                                                cả</option>
                                            <option value="1" <?php echo ($selectedMonth == 1) ? 'selected' : ''; ?>>
                                                Tháng 1</option>
                                            <option value="2" <?php echo ($selectedMonth == 2) ? 'selected' : ''; ?>>
                                                Tháng 2</option>
                                            <option value="3" <?php echo ($selectedMonth == 3) ? 'selected' : ''; ?>>
                                                Tháng 3</option>
                                            <option value="4" <?php echo ($selectedMonth == 4) ? 'selected' : ''; ?>>
                                                Tháng 4</option>
                                            <option value="5" <?php echo ($selectedMonth == 5) ? 'selected' : ''; ?>>
                                                Tháng 5</option>
                                            <option value="6" <?php echo ($selectedMonth == 6) ? 'selected' : ''; ?>>
                                                Tháng 6</option>
                                            <option value="7" <?php echo ($selectedMonth == 7) ? 'selected' : ''; ?>>
                                                Tháng 7</option>
                                            <option value="8" <?php echo ($selectedMonth == 8) ? 'selected' : ''; ?>>
                                                Tháng 8</option>
                                            <option value="9" <?php echo ($selectedMonth == 9) ? 'selected' : ''; ?>>
                                                Tháng 9</option>
                                            <option value="10" <?php echo ($selectedMonth == 10) ? 'selected' : ''; ?>>
                                                Tháng 10</option>
                                            <option value="11" <?php echo ($selectedMonth == 11) ? 'selected' : ''; ?>>
                                                Tháng 11</option>
                                            <option value="12" <?php echo ($selectedMonth == 12) ? 'selected' : ''; ?>>
                                                Tháng 12</option>

                                        </select>

                                        <button type="submit" class="btn btn-success m-2" id="exportExcel">Xuất
                                            Excel</button>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary">
                                                        <a style="color: white" ;
                                                            href="order_detail.php?id=<?php echo $value['OderId'] ?>">Chi
                                                            tiết</a>
                                                    </button>
                                                </td>
                                            </tr>
                            ...
                            <div class="col-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3>Thương Hiệu</h3>
                                        <p class="card-title text-nowrap mb-1">Số lượng: <?php echo $quantity_brands ?>
                                        </p>
                                        <a href="brand_list.php" class="mt-2 btn btn-sm btn-outline-primary">Xem chi
                                            tiết</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3>Loại Bánh</h3>
                                        <p class="card-title text-nowrap mb-1">Số lượng:
                                            <?php echo $quantity_category ?> </p>
                                        <a href="category_list.php" class="mt-2 btn btn-sm btn-outline-primary">Xem chi
                                            tiết</a>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row"> -->
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                                            <div
                                                ...
                                                <p class="card-title text-nowrap mb-1">Số lượng:
                                                    <?php echo $quantity_orders ?> </p>
                                                <a href="order_list.php" class="mt-2 btn btn-sm btn-outline-primary">Xem
                                                    chi tiết</a>
                                            </div>
                                        </div>
                                    </div>
        ...
        function changeMonth() {
            ...
            window.location.href = 'index.php?thang=' + selectedMonth;
        }

        document.getElementById('exportExcel').addEventListener('click', function() {
            // Gửi yêu cầu xuất Excel đến máy chủ
            window.location.href = 'export_excel.php?thang=' + document.getElementById('thang').value;
        });
        </script>
        <!--  <script>-->
        <!--    document.getElementById('exportExcel').addEventListener('click', function() {-->
